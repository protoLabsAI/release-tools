 ...
 *
 * Two recommendations are codified here:
 *
 ...
 * @returns {{ ruleset: object, diff: { addedContexts: string[], removedContexts: string[], strictBefore: boolean|null, strictAfter: boolean } }}
 */
